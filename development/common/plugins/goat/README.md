...
**G**eneralized **O**ccupational **A**ptitude **T**est. In the Vault the test decides your job; here the tests decide what ships. `geiger` then scans what you deployed for radiation.
